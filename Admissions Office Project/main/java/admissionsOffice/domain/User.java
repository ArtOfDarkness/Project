...
public class User implements UserDetails {
	...
	@Column
	@NotBlank(message = "Прізвище користувача не може бути пустим!")
	private String lastName;
	@Column
	@NotBlank(message = "Email користувача не може бути пустим!")
	@Email(message = "Email користувача введений некорректно!")
